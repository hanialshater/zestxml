...
sys.path.insert(0, "/home/user/zestxml"); sys.path.insert(0, "/home/user/zestxml/tools")
torch.set_num_threads(2)
from zestxml.io import read_text_smat, read_bin_smat
from eval_xc import inv_propensity, evaluate
from baselines.label_graph import csr_to_scipy, build_graph, propagate, scipy_to_csr
